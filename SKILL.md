...
- **详实度下限(v2)**:每章 `narrative` 书 ≥800 字 / 视频段 ≥400 字(G9);宁可少论点讲透,不注水;**标志性案例 / 故事必须整段完整讲**(时间·人物·动作·转折·结果),禁压成一句标签。高保留书中真实短来源附记仅按 [专门契约 §5](references/high-retention-books.md#5-三层阅读与页面放行) 的逐项人工回执与完整校验入口处理，不能给主内容贴标签降档。
